...
standalone: false
hierarchy: "L1 Core UI Build Production > UI Build Production Skill > Page Visual Rhythm & Spacing Governance Add-on"
---
...
> 文件路径：`.codex/skills/l2-addons/ui-build-governance/page-visual-rhythm-spacing-governance-skill-v1.0.0-l5.md`
