...
depends_on:
  ...
  - "page overlay matrix"
standalone: false
hierarchy: "L1 Core UI Build Production > UI Build Production Skill > App Modal & Overlay System Governance Add-on"
---
...
> 文件路径：`.codex/skills/l2-addons/ui-build-governance/app-modal-overlay-system-governance-skill-v2.0.0-l5.md`
