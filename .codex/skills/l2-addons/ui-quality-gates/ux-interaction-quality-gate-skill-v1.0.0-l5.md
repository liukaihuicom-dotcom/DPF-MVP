...
standalone: false
hierarchy: "L1 Core UI Build Production > UI Build Production Skill > UX Interaction Quality Gate Add-on"
---
...
> 文件路径：`.codex/skills/l2-addons/ui-quality-gates/ux-interaction-quality-gate-skill-v1.0.0-l5.md`  
> 版本：`v1.0.0-L5`  
