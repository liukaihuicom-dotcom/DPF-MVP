...
layer: L2
category: "UI Quality Gate Add-on"
...
depends_on:
  ...
  - "redline items"
  - "fix cards"
  - "Page Contract and Design System context"
standalone: false
hierarchy: "L1 Core UI Build Production > UI Build Production Skill > Elite UX/UI Remediation Board Add-on"
---
...
> 文件路径：`.codex/skills/l2-addons/ui-quality-gates/elite-ux-ui-remediation-board-skill-v4.0.0-l5.md`
