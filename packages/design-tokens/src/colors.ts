...
export const themeColors: Record<ResolvedThemeMode, ThemeColors> = {
  darkTerminal: {
    ...
    chart: {
      ...
      diverging: { negative: '#FF6478', neutral: '#B8B8B8', positive: '#2EA379' },
    ...
    market: {
      down: state({ bg: colorPrimitives.market.down['950'], border: colorPrimitives.market.down['700'], fg: '#FF5A68', solid: colorPrimitives.market.down['500'] }),
      flat: state({ bg: '#222222', border: '#444444', fg: '#B8B8B8', solid: '#71717A' }),
      up: state({ bg: colorPrimitives.market.up['950'], border: colorPrimitives.market.up['700'], fg: '#2EA379', solid: '#2EA379' }),
    },
    overlay: {
  ...
  lightBroker: {
    ...
    chart: {
      ...
      diverging: { negative: colorPrimitives.red['700'], neutral: neutral['500'], positive: '#2EA379' },
    ...
    market: {
      down: state({ bg: colorPrimitives.market.down['50'], border: colorPrimitives.market.down['200'], fg: colorPrimitives.market.down['700'], solid: colorPrimitives.market.down['700'] }),
      flat: state({ bg: neutral['100'], border: neutral['300'], fg: neutral['500'], solid: neutral['500'] }),
      up: state({ bg: colorPrimitives.market.up['50'], border: colorPrimitives.market.up['200'], fg: '#2EA379', solid: '#2EA379' }),
    },
    overlay: {
      ...
      down: overlays(colorPrimitives.market.down['700']),
  ...
  midnightBlue: {
    ...
    chart: {
      categorical: [teal['500'], colorPrimitives.blue['400'], colorPrimitives.amber['400'], colorPrimitives.purple['400'], colorPrimitives.green['400'], colorPrimitives.red['400'], colorPrimitives.cyan['400'], colorPrimitives.blue['300'], colorPrimitives.amber['300'], colorPrimitives.purple['300'], colorPrimitives.green['300'], colorPrimitives.red['300']],
      diverging: { negative: '#FF6478', neutral: '#BDBDBD', positive: '#2EA379' },
      sequential: { high: teal['300'], low: '#123337', mid: teal['500'] },
    },
    icon: {
      active: '#F8FAFC',
    ...
    market: {
      down: state({ bg: colorPrimitives.market.down['950'], border: colorPrimitives.market.down['700'], fg: '#FF6478', solid: colorPrimitives.market.down['500'] }),
...
export type ThemeToneKey = 'amber' | 'bg' | 'blue' | 'brand' | 'cyan' | 'danger' | 'default' | 'dim' | 'disabled' | 'down' | 'link' | 'muted' | 'panel' | 'panelMuted' | 'success' | 'text' | 'textDim' | 'textMuted' | 'up' | 'white';
