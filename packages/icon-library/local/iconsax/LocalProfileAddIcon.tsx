/* Vendored from iconsax-react-native ProfileAdd; source license: MIT. */
...
export function LocalIconsaxProfileAddIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
