/* Vendored from iconsax-react-native People; source license: MIT. */
...
export function LocalIconsaxPeopleIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
