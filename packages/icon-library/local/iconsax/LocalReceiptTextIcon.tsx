/* Vendored from iconsax-react-native ReceiptText; source license: MIT. */
...
export function LocalIconsaxReceiptTextIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
