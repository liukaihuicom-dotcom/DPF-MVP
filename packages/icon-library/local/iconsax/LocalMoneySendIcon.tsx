/* Vendored from iconsax-react-native MoneySend; source license: MIT. */
...
export function LocalIconsaxMoneySendIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
