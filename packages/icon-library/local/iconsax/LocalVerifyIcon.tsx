/* Vendored from iconsax-react-native Verify; source license: MIT. */
...
export function LocalIconsaxVerifyIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
