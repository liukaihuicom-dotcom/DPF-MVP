/* Vendored from iconsax-react-native Notification; source license: MIT. */
...
export function LocalIconsaxNotificationIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
