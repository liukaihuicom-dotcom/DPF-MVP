/* Vendored from iconsax-react-native Archive; source license: MIT. */
...
export function LocalIconsaxArchiveIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
