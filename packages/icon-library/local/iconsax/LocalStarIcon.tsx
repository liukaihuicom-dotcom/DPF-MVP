/* Vendored from iconsax-react-native Star; source license: MIT. */
...
export function LocalIconsaxStarIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
