/* Vendored from iconsax-react-native Clock; source license: MIT. */
...
export function LocalIconsaxClockIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
