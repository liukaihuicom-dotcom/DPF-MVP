/* Vendored from iconsax-react-native TrendUp; source license: MIT. */
...
export function LocalIconsaxTrendUpIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
