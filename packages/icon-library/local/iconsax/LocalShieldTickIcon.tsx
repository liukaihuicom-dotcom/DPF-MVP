/* Vendored from iconsax-react-native ShieldTick; source license: MIT. */
...
export function LocalIconsaxShieldTickIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
