/* Vendored from iconsax-react-native Apple; source license: MIT. */
...
export function LocalIconsaxAppleIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
