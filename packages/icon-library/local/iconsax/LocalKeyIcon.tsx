/* Vendored from iconsax-react-native Key; source license: MIT. */
...
export function LocalIconsaxKeyIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
