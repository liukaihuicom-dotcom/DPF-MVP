/* Vendored from iconsax-react-native Teacher; source license: MIT. */
...
export function LocalIconsaxTeacherIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
