/* Vendored from iconsax-react-native PasswordCheck; source license: MIT. */
...
export function LocalIconsaxPasswordCheckIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
