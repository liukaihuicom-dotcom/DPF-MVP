/* Vendored from iconsax-react-native BookSaved; source license: MIT. */
...
export function LocalIconsaxBookSavedIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
