...
export const routeRegistry = [
  ...
  },
  {
    ...
    navigationLevel: 'root',
    ...closeToLaunch,
    primaryActions: ['Enter account', 'Enter password', 'Submit login', 'Use remembered account', 'Open forgot password'],
    relatedModals: ['auth.errorSheet', 'global.toastFeedback'],
    states: formStates,
    routePresentation: 'screen',
    riskLevel: 'medium',
  },
