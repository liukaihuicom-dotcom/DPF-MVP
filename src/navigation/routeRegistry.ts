...
const closeToTrade = { closeTarget: '/trade', topNavBehavior: 'close' } as const;
const closeToDiscover = { closeTarget: '/discover', topNavBehavior: 'close' } as const;
...
export const routeRegistry = [
  ...
  {
    path: '/workspace',
    pageComponent: 'WorkspaceScreen',
    module: 'Workspace',
    permission: 'guest / signedIn.optional',
    navigationLevel: 'primaryTab',
    ...noTopNav,
    primaryActions: ['Review role-aware workspace status', 'Open guided next step', 'Open quiet assist entry'],
    relatedModals: ['global.toastFeedback'],
    states: ['default', 'loading', 'empty', 'error', 'permission_denied', 'restricted', 'reviewing'],
    routePresentation: 'tab',
    riskLevel: 'medium',
    permissionGap: 'Workspace state is derived from local settings and mock account data until production identity, KYC, funding, and partner entitlement services are integrated.',
  },
  {
    path: '/learn',
    pageComponent: 'LearnRoute',
    module: 'Discover',
    permission: 'guest',
    navigationLevel: 'primaryTab',
    ...noTopNav,
    primaryActions: ['Review learning and risk education entries', 'Open paper-practice support content'],
    relatedModals: ['global.toastFeedback'],
    states: basicStates,
    routePresentation: 'tab',
    riskLevel: 'low',
    routingReview: 'Workspace bottom-tab semantic wrapper for education module; deep learning business system remains planned.',
  },
  {
    path: '/demo',
    pageComponent: 'DemoRoute',
    module: 'Discover',
    permission: 'guest',
    navigationLevel: 'primaryTab',
    ...noTopNav,
    ...
    routePresentation: 'tab',
    riskLevel: 'medium',
    routingReview: 'Demo tab must not expose real funding or live trading execution for new Trader states.',
  },
  {
    path: '/markets',
  ...
  },
  {
    ...
    navigationLevel: 'primaryTab',
    ...noTopNav,
    primaryActions: ['Review Partner client funnel', 'Open client profile', 'Review upgrade status'],
    relatedModals: ['global.toastFeedback'],
    states: protectedStates,
    routePresentation: 'tab',
    riskLevel: 'high',
    permissionGap: 'Partner client data is local mock state; production requires approved entitlement, hierarchy scope, PII policy, and audit checks.',
  },
  {
    path: '/growth',
    ...
    navigationLevel: 'primaryTab',
    ...noTopNav,
    primaryActions: ['Open Partner growth tools', 'Select approved material or function module'],
    relatedModals: ['global.toastFeedback'],
    states: protectedStates,
    routePresentation: 'tab',
    riskLevel: 'medium',
    permissionGap: 'Partner growth tools are local preview assets and must be backed by production entitlement and approved-material governance.',
  },
  {
    path: '/wallet',
    ...
    navigationLevel: 'primaryTab',
    ...noTopNav,
    primaryActions: ['Review pending rebates', 'Review settled rebates', 'Inspect commission rules'],
    relatedModals: [],
    states: protectedStates,
    routePresentation: 'tab',
    riskLevel: 'medium',
    permissionGap: 'Partner commission wallet is local preview data; production requires settlement, statement, tax, and reporting integration.',
  },
  {
    path: '/me',
    ...
    navigationLevel: 'primaryTab',
    ...noTopNav,
    primaryActions: ['Review profile module', 'Open security settings', 'Open appearance settings'],
    relatedModals: ['global.toastFeedback'],
    states: protectedStates,
    routePresentation: 'tab',
    riskLevel: 'medium',
  ...
  },
  {
    ...
    topNavBehavior: 'back',
    primaryActions: ['Open partner growth tools', 'Select growth module', 'Open client or commission workspace'],
    relatedModals: ['global.toastFeedback'],
    states: protectedStates,
    routePresentation: 'screen',
    riskLevel: 'medium',
    permissionGap: 'Partner tools are local previews and must be backed by production partner entitlement checks before release.',
  },
  {
