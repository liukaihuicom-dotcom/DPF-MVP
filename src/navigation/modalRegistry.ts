...
export const modalRegistry = [
  ...
  },
  {
    ...
    modalComponent: 'AuthContactConfirmDialog',
    ...
    confirmNavBehavior: 'submitThenNavigate',
    routeable: false,
    closeBehavior: 'Non-sheet exception: cancel the centered confirmation dialog and return to the same form with current input preserved.',
    confirmBehavior: 'Confirm the visible contact target and navigate to the next code route.',
    riskLevel: 'medium',
  },
  {
    id: 'auth.leaveVerifiedStep',
    modalComponent: 'AuthLeaveVerifiedStepDialog',
    triggerPages: ['/auth/register-phone', '/auth/register-password'],
    triggerActions: ['Back from a verified registration step'],
    modalCloseBehavior: 'cancel',
    confirmNavBehavior: 'submitThenNavigate',
    routeable: false,
    closeBehavior: 'Cancel the confirmation and stay on the current verified step.',
  ...
  {
    id: 'auth.errorDialog',
    modalComponent: 'AuthErrorDialog',
    triggerPages: ['/auth/pin-setup'],
    triggerActions: ['Enter mismatched PIN confirmation or wrong unlock PIN'],
    modalCloseBehavior: 'dismiss',
    confirmNavBehavior: 'acknowledge',
    routeable: false,
    closeBehavior: 'Non-sheet exception: dismiss dialog and keep the user on PIN entry.',
  ...
  },
  {
    ...
    routeable: false,
    closeBehavior: 'Dismiss current sheet through shared backdrop tap, pan-down gesture, or nested back to the previous sheet.',
