...
export const modalRegistry = [
  {
    ...
    routeable: true,
    routePath: '/order/[id]',
    closeBehavior: 'Close the full-screen Modal Page to the previous route, or replace with /trade when no history exists; dirty tickets require queued leave confirmation.',
