/* Vendored from iconsax-react-native SearchNormal; source license: MIT. */
...
export function LocalIconsaxSearchNormalIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
