/* Vendored from iconsax-react-native Setting2; source license: MIT. */
...
export function LocalIconsaxSetting2Icon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
