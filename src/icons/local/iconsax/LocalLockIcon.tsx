/* Vendored from iconsax-react-native Lock; source license: MIT. */
...
export function LocalIconsaxLockIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
