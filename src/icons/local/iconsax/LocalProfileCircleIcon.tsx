/* Vendored from iconsax-react-native ProfileCircle; source license: MIT. */
...
export function LocalIconsaxProfileCircleIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
