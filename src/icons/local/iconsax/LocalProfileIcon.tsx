/* Vendored from iconsax-react-native Profile; source license: MIT. */
...
export function LocalIconsaxProfileIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
