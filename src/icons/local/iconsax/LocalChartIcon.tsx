/* Vendored from iconsax-react-native Chart; source license: MIT. */
...
export function LocalIconsaxChartIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
