/* Vendored from iconsax-react-native Share; source license: MIT. */
...
export function LocalIconsaxShareIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
