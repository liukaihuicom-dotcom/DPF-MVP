/* Vendored from iconsax-react-native TrendDown; source license: MIT. */
...
export function LocalIconsaxTrendDownIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
