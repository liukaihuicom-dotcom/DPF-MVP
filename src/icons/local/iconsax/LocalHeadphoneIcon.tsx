/* Vendored from iconsax-react-native Headphone; source license: MIT. */
...
export function LocalIconsaxHeadphoneIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
