/* Vendored from iconsax-react-native Gift; source license: MIT. */
...
export function LocalIconsaxGiftIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
