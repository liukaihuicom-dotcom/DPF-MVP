/* Vendored from iconsax-react-native Global; source license: MIT. */
...
export function LocalIconsaxGlobalIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
