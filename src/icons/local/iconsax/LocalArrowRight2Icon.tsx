/* Vendored from iconsax-react-native ArrowRight2; source license: MIT. */
...
export function LocalIconsaxArrowRight2Icon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
