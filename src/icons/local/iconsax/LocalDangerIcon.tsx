/* Vendored from iconsax-react-native Danger; source license: MIT. */
...
export function LocalIconsaxDangerIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
