/* Vendored from iconsax-react-native Personalcard; source license: MIT. */
...
export function LocalIconsaxPersonalcardIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
