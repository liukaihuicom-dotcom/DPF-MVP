/* Vendored from iconsax-react-native Information; source license: MIT. */
...
export function LocalIconsaxInformationIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
