/* Vendored from iconsax-react-native Profile2User; source license: MIT. */
...
export function LocalIconsaxProfile2UserIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
