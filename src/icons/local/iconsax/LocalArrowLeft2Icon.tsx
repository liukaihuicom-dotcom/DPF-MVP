/* Vendored from iconsax-react-native ArrowLeft2; source license: MIT. */
...
export function LocalIconsaxArrowLeft2Icon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
