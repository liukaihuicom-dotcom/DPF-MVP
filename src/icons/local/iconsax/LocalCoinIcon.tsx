/* Vendored from iconsax-react-native Coin; source license: MIT. */
...
export function LocalIconsaxCoinIcon({ color = 'currentColor', height, size = 24, style, styleVariant = 'line', width }: LocalIconProps) {
