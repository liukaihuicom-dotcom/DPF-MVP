...
|---|---|---|---|---|
| `order.ticket.route` | yes | `/order/[id]` | high | Route-backed global BottomSheet order ticket for trading flow recovery and direct entry. |
...
| `auth.languageSheet` | no | N/A | low | Language picker sheet for Auth header actions. |
...
| `discover.profileEditSheet` | no | N/A | low | Profile edit sheet rendered through public BottomSheet opener. |
| `discover.managerChatSheet` | no | N/A | medium | Manager chat preview sheet rendered through public BottomSheet opener. |
