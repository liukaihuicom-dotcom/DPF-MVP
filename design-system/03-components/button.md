...
| disabled | `disabled` | Non-text buttons use `palette.disabledSurface` and `palette.disabledBorder` so inactive primary CTAs remain visible against panel surfaces; text, icons, and loading spinner use `palette.disabledText` |
