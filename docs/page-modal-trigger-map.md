...
| `/funding/deposit`, `/funding/withdrawal`, `/funding/transfer` | Submit funding form | `funding.submitFeedbackToast` | Non-routeable toast; handler navigates to `/funding/transactions/[id]` |
